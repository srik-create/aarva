...
| 2026-06-26 | Search UX: NL chatbox primary, structured filters secondary (deferred) | One-input UI; advanced toggle added later | Filter UI is additive |
| 2026-06-26 | Crosscut-on-demand UX: automatic suggestion on every search | Better product feel than explicit button | Feature flag if it becomes expensive |
